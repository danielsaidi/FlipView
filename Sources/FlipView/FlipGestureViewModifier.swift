...
public struct FlipGestureViewModifier: ViewModifier {
    ...
    ///
    /// - Parameters:
    ///   - maximumTime: The maximum time the gesture can be active before cancelling itself, by default `1`.
    ...
    ///   - up: The action to trigger when the user flips up, if any.
    ///   - left: The action to trigger when the user flips left, if any.
